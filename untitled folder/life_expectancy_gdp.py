...
#Chile, China, Germany, Mexico, United States, Zimbabawe
...
# The collums in the first chart have a wide range of y values, while those in the second chart are fairly similar. 
...
#Zimbabawe changed the most. 
#The changes between years are pretty constant. 
#Chile has had the least change in GDP over time 
#Apart from Zimbabawe, they are all relativitly similar 
#They are not that similar 
#GDP and life expecatacy is due to numerous factors such as access to public health, government policy, war ect. 
...
#United States has the highest. Zimbabawe has the lowest. 
...
#Germany has the highest. Zimbabawe has the lowest. 
...
#Increase number of students in secondary education, elimination of the one child policy, increase useage of the internet and numerous new economic policies. 
